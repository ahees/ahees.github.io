...
$(window).on("load",function(){var e=$("#p_prldr");e.find(".svg_anm").fadeOut(),e.delay(500).fadeOut("slow")}),$(function(){function e(){$(".auto_height").css("height",$(window).height()/1.5)}$("#gotop a").mPageScroll2id(),e(),$(window).resize(function(){e()}),$(".easyway").parallax({imageSrc:"./img/min_bg1.jpg",speed:.1}),$(".holidays").parallax({imageSrc:"./img/min_bg6.jpg",speed:.1}),$("#holidayskids").parallax({imageSrc:"./img/min_bg2.jpg",speed:.1}),$("#light").parallax({imageSrc:"./img/min_bg5.jpg",speed:.1}),$("#order").parallax({imageSrc:"./img/min_bg3.jpg",speed:.1}),$("#order_2").parallax({imageSrc:"./img/min_bg4.jpg",speed:.1}),$(".owl-carousel").owlCarousel({loop:!0,autoHeight:!0,responsiveClass:!0,responsive:{0:{items:1},600:{items:1,nav:!1},1e3:{items:2}}});var o=$(".owl-carousel");o.owlCarousel(),$(".owl_right").click(function(){o.trigger("next.owl.carousel")}),$(".owl_left").click(function(){o.trigger("prev.owl.carousel",[300])});try{$.browserSelector(),$("html").hasClass("chrome")&&$.smoothScroll()}catch(e){}$("img, a").on("dragstart",function(e){e.preventDefault()}),$(".top_menu .menu a").mPageScroll2id({offset:200}),$(".feedback").magnificPopup({type:"inline"}),$(".close").click(function(){$(".mfp-close").trigger("click")}),$(".gallery_items").magnificPopup({delegate:"a",type:"image",tLoading:"Загрузка изображения #%curr%...",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]}}),$(".tooglebutton").on("click",function(){$(".menu").slideToggle(300,function(){"none"===$(this).css("display")&&$(this).removeAttr("style")})}),console.log($(window).width()),$(window).width()<790&&$(".top_menu .menu a").on("click",function(){$(".top_menu .menu").hide()})}),$(window).scroll(function(){$(this).scrollTop()>80?$("#gotop").css("opacity",".8"):$("#gotop").css("opacity","0")});